...
training_args = GRPOConfig(
    ...
    # ========================================================================
    # 🚀 生产参数 (全量训练: 7470 条数据)
    # ⚠️  注意：GRPO + DDP 下 gradient_accumulation 不生效，改用更大的 batch_size
    # ========================================================================
    per_device_train_batch_size=4,  # 每个 GPU 4 条（2 GPU = 8 条总批次）
    gradient_accumulation_steps=1,  # DDP 下设为 1（不使用梯度累积）
